...
Found 98646 images belonging to 6 classes.
Found 15719 images belonging to 6 classes.
"""
...
checkpointer = ModelCheckpoint(
    filepath='./data/checkpoints1/inception.{epoch:04d}-{val_loss:.2f}.hdf5',
    verbose=1,
    save_best_only=True)
...
# Helper: TensorBoard
tensorboard = TensorBoard(log_dir='./data/logs1/')
...
def train_model(model, nb_epoch, generators, callbacks=[],filepath=None,):
...
if __name__ == '__main__':
    ...
    weights_file = 'data/checkpoints/inception.0026-2.54.hdf5'
    main(weights_file)
    endtime = datetime.datetime.now()
    print('程序运行时间为：' + str((endtime - starttime).seconds / 60.) + '分钟')